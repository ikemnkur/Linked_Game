  ...
  return (
    <div className="rules-page">
      <div className="rules-header">
        <button className="btn-secondary" onClick={() => navigate(user ? '/lobby' : '/')}>← Back</button>
      ...
      <div className="rules-content card">
        ...
        <section className="rules-section">
          ...
          <ul>
            ...
            <li>2-4 players: <span className="color-tag red">Red</span>, <span className="color-tag blue">Blue</span>, <span className="color-tag green">Green</span>, <span className="color-tag yellow">Yellow</span></li>
        ...
        <section className="rules-section">
          ...
          <ul>
            <li><strong>Total Time:</strong> Each player gets X minutes for the entire game (chess-clock style)<br /> * Elimination: When a player's time runs out, they are eliminated and their pieces are removed</li>
            <li><strong>Per Turn:</strong> Each move must be made within Y seconds (minimum 10s, resets each turn)<br /> * Skip: When a player's time runs out, their turn is skipped and the opponent's turn begins</li>
          </ul>
        </section>
        ...
        <div className="rules-footer">
          <button onClick={() => navigate(user ? '/lobby' : '/')}>Start Playing</button>
          <button className="btn-secondary" onClick={() => navigate('/practice')}>Try Practice Room</button>
        </div>
      </div>
    </div>
  );
