...
export function getConnectedComponents(board, color) {
  const pieces = [];
...
export function removeUnlinkedPieces(board, color) {
...
export function processMove(board, playerColor, from, to) {
...
export function getLegalMoves(board, playerColor, fromR, fromC) {
  const moves = [];
  // Orthogonal
  ...
  // 2-step diagonal (checker-style hop)
...
export function countCenter(board, color) {
  let points = 0;
...
export { BOARD_SIZE, CENTER_SQUARES, COLORS };
